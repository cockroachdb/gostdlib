...
import (
	...
	"github.com/cockroachdb/gostdlib/x/tools/go/gcexportdata"
	"github.com/cockroachdb/gostdlib/x/tools/internal/gocommand"
	"github.com/cockroachdb/gostdlib/x/tools/internal/packagesinternal"
	"github.com/cockroachdb/gostdlib/x/tools/internal/typeparams"
	"github.com/cockroachdb/gostdlib/x/tools/internal/typesinternal"
)
...
func (ld *loader) loadFromExportData(lpkg *loaderPackage) (*types.Package, error) {
	...
	if viewLen != len(view) {
		log.Panicf("github.com/cockroachdb/gostdlib/x/tools/go/packages: unexpected new packages during load of %s", lpkg.PkgPath)
	}
