...
// how to use github.com/cockroachdb/gostdlib/x/tools/go/packages to load, parse,
...
import (
	...
	"github.com/cockroachdb/gostdlib/x/tools/go/types/typeutil"
	"github.com/cockroachdb/gostdlib/x/tools/internal/tool"
)
