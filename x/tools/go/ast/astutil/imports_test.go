...
`)
	...
	AddImport(fset, file, "github.com/cockroachdb/gostdlib/x/tools/go/ast/astutil")
	AddImport(fset, file, "os")
	want := `package main

import (
	"github.com/cockroachdb/gostdlib/x/tools/go/ast/astutil"
	"os"
)
...
import (
	...
	"github.com/cockroachdb/gostdlib/go/format" // e
)
`,
		out: `package main
