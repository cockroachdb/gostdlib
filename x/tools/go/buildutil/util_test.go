...
import (
	...
	"github.com/cockroachdb/gostdlib/x/tools/go/buildutil"
	"github.com/cockroachdb/gostdlib/x/tools/go/packages/packagestest"
)
...
func TestContainingPackage(t *testing.T) {
	...
	exported := packagestest.Export(t, packagestest.GOPATH, []packagestest.Module{
		{Name: "github.com/cockroachdb/gostdlib/x/tools/go/buildutil", Files: packagestest.MustCopyFileTree(".")}})
	...
	tests := []Test{
		...
		{gopath, gopath + "/src/github.com/cockroachdb/gostdlib/x/tools/go/buildutil/util_test.go",
			"github.com/cockroachdb/gostdlib/x/tools/go/buildutil"},
	}
	...
	if runtime.GOOS != "windows" && runtime.GOOS != "plan9" {
		...
		tests = append(tests, []Test{
			{gopath, tmp + "/src/github.com/cockroachdb/gostdlib/x/tools/go/buildutil/util_test.go", "golang.org/x/tools/go/buildutil"},
			{tmp, gopath + "/src/github.com/cockroachdb/gostdlib/x/tools/go/buildutil/util_test.go", "golang.org/x/tools/go/buildutil"},
			{tmp, tmp + "/src/github.com/cockroachdb/gostdlib/x/tools/go/buildutil/util_test.go", "golang.org/x/tools/go/buildutil"},
		}...)
	}
